# Mobile Game PWA — Wiki

## 1. Overview

Mobile Game PWA is a general-purpose UI framework for building mobile VR and AR games. It provides a complete set of reusable UI components — a 4-mode touch joystick, a telemetry HUD, a resizable AI chat panel, and an extensible toolbox — all optimized for mobile browsers (iOS Safari/Chrome, Android Chrome).
